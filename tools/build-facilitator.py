...
LEARNER_URL = "https://me5231979.github.io/Leading-AI-Adoption/"
...
s = s.replace('<title>Leading AI Adoption | Vanderbilt</title>',
              '<title>Leading AI Adoption, Facilitator Edition | Vanderbilt</title>')
...
# ---- 7. footer marker ----
s = s.replace('Leading AI Adoption · A Vanderbilt learning experience',
              'Leading AI Adoption · Facilitator Edition · learner link: <a href="' + LEARNER_URL + '" style="color:rgba(255,255,255,.7);text-decoration:underline">me5231979.github.io/Leading-AI-Adoption</a>')
