...
META = {
 ...
 "AI-Guardrails": ("ai-guardrails", "ai", STAFF, False,
   "AI Basics taught the traffic light. This is the session that writes the rest down. Stanford's AI Index counts AI misuse incidents climbing right alongside adoption, and at a university holding FERPA-protected records, good intentions are not a policy. Learners build the Four Lines, a one-page team agreement covering what data may go in, when a human must verify, when readers are told AI helped, and who owns the output. The hard cases get their own drills: student work, meeting notes, letters about people.",
 ...
 "Leading-AI-Adoption": ("making-ai-normal", "ai leadership", MGR, True,
   "The 90-minute companion to the short Leading AI Adoption course, for managers who want the full method. Gallup names manager modeling and workflow integration the two strongest predictors of a team actually using AI, and most employees say nobody ever told them what is encouraged. This session teaches Show, Say, Set, Sustain: narrating your own use including the misses, giving explicit permission and explicit limits, installing AI into the rituals where habits live, and holding the practice past the month-three novelty cliff.",
