...
LEARNER_URL = "https://me5231979.github.io/Course_Library/courses/People-Data-with-AI/"
...
s = s.replace('<title>People Data with AI | Vanderbilt</title>',
              '<title>People Data with AI, Facilitator Edition | Vanderbilt</title>')
...
# ---- 7. footer marker ----
s = s.replace('People Data with AI · A Vanderbilt learning experience',
              'People Data with AI · Facilitator Edition · <a href="' + LEARNER_URL + '" style="color:rgba(255,255,255,.7);text-decoration:underline">learner link</a>')
