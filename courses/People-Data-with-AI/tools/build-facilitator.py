...
s = s.replace('<title>People Data, Safely | Vanderbilt</title>',
              '<title>People Data, Safely, Facilitator Edition | Vanderbilt</title>')
...
# ---- 7. footer marker ----
s = s.replace('People Data, Safely · A Vanderbilt learning experience',
              'People Data, Safely · Facilitator Edition · <a href="' + LEARNER_URL + '" style="color:rgba(255,255,255,.7);text-decoration:underline">learner link</a>')
