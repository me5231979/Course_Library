...
LEARNER_URL = "https://me5231979.github.io/Course_Library/courses/Trust-Then-Verify/"
...
s = s.replace('<title>Trust, Then Verify | Vanderbilt</title>',
              '<title>Trust, Then Verify, Facilitator Edition | Vanderbilt</title>')
...
# ---- 7. footer marker ----
s = s.replace('Trust, Then Verify · A Vanderbilt learning experience',
              'Trust, Then Verify · Facilitator Edition · learner link: <a href="' + LEARNER_URL + '" style="color:rgba(255,255,255,.7);text-decoration:underline">me5231979.github.io/Course_Library/courses/Trust-Then-Verify</a>')
