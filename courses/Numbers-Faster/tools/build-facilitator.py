...
LEARNER_URL = "https://me5231979.github.io/Course_Library/courses/Numbers-Faster/"
...
s = s.replace('<title>Numbers, Faster | Vanderbilt</title>',
              '<title>Numbers, Faster, Facilitator Edition | Vanderbilt</title>')
...
# ---- 7. footer marker ----
s = s.replace('Numbers, Faster · A Vanderbilt learning experience',
              'Numbers, Faster · Facilitator Edition · learner link: <a href="' + LEARNER_URL + '" style="color:rgba(255,255,255,.7);text-decoration:underline">the learner edition</a>')
