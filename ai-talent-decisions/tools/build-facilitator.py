...
s = s.replace('AI for Talent Decisions · A Vanderbilt learning experience',
              'AI for Talent Decisions · Facilitator Edition · learner link: <a href="' + LEARNER_URL + '" style="color:rgba(255,255,255,.7);text-decoration:underline">me5231979.github.io/Course_Library/ai-talent-decisions</a>')
